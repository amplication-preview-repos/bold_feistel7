...
describe("Transaction", () => {
  ...
  test("POST /transactions", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        cardExpirationDate: CREATE_RESULT.cardExpirationDate.toISOString(),
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          cardExpirationDate:
            FIND_MANY_RESULT[0].cardExpirationDate.toISOString(),
  ...
  test("GET /transactions/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        cardExpirationDate: FIND_ONE_RESULT.cardExpirationDate.toISOString(),
